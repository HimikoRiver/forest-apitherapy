...
export default function FooterDesktop() {
  return (
    ...
    >
      ...
      <div
        aria-hidden="true"
        className="relative z-20 mx-auto flex h-[clamp(82px,7.4vw,138px)] w-full max-w-[1680px] items-center bg-black px-6 sm:px-10 md:px-14 lg:px-20"
      >
        <div className="grid w-full translate-y-[20px] grid-cols-[1fr_clamp(70px,8vw,150px)_1fr] items-center gap-[clamp(16px,2.2vw,38px)]">
