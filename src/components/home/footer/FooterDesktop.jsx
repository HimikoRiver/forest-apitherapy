...
export default function FooterDesktop() {
  return (
    ...
    >
      ...
      <div
        aria-hidden="true"
        className="relative z-20 mx-auto flex h-[clamp(66px,5.9vw,110px)] w-full max-w-[1680px] items-center bg-black px-6 sm:px-10 md:px-14 lg:px-20"
      >
        <div className="grid w-full translate-y-[44px] grid-cols-[1fr_clamp(70px,8vw,150px)_1fr] items-center gap-[clamp(16px,2.2vw,38px)]">
      ...
      <div className="relative mx-auto h-[clamp(390px,31vw,652px)] w-full max-w-[2047px] overflow-hidden bg-black">
        <Image
          src="/images/footer/footerFon232.webp"
          alt=""
          fill
          priority={false}
          sizes="100vw"
        ...
        <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(180deg,rgba(0,0,0,0.02)_0%,rgba(0,0,0,0)_46%,rgba(0,0,0,0.18)_100%)]" />

        <div className="absolute right-[15.2%] top-[10.4%] z-10 w-[42.5%]">
          <FooterCards />
        </div>

        <div
          aria-hidden="true"
          className="pointer-events-none absolute bottom-[9.2%] left-[6.7%] right-[6.7%] z-10 grid grid-cols-[1fr_clamp(90px,8vw,160px)_1fr] items-center gap-[clamp(14px,1.7vw,30px)]"
        >
