...
import LazyOrmedBookSlider from "@/components/services/LazyOrmedBookSlider";
            ...
            <div className="relative z-10 grid lg:grid-cols-2">
              <div className="relative flex items-center px-5 py-6 sm:px-7 lg:px-8 lg:pr-28">
                <p className="pr-10 text-[11px] font-semibold leading-6 text-[#d7aa51] sm:pr-20 sm:text-[12px] lg:pr-0 lg:text-[13px]">
                  Не откладывайте заботу о своём здоровье на
                  потом — обратитесь к нам прямо сейчас и начните
                  путь к более свободному движению и комфортной
                  жизни.
                </p>
              ...
              <div className="flex items-center gap-5 border-t border-[#a57833]/30 px-5 py-6 sm:px-7 lg:border-l lg:border-t-0 lg:px-8">
                ...
                <p className="text-[11px] font-medium leading-6 text-[#d8c9aa]/82 sm:text-[12px] lg:text-[13px]">
                  Имеются противопоказания. Процедура строго
                  противопоказана при остеопорозе, опухолях,
                  инфекциях и травмах, нестабильности позвонков
