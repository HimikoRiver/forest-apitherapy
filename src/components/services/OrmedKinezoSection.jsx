  ...
  return (
    <div className="relative">
      ...
      <div className="relative px-2 pb-6 pt-8 sm:px-4 sm:pb-8 sm:pt-10 lg:p-0">
        ...
        <div className="relative overflow-hidden rounded-[24px] bg-[linear-gradient(135deg,rgba(120,79,24,0.95),rgba(246,220,154,0.95),rgba(141,89,28,0.95),rgba(255,240,190,0.92),rgba(122,79,24,0.95))] p-[1px] sm:rounded-[28px] lg:p-0">
          <div className="relative overflow-hidden rounded-[23px] bg-[#03110d] p-[8px] sm:rounded-[27px] sm:p-[10px] lg:bg-transparent lg:p-0">
            <div
              aria-hidden="true"
          ...
          <div className="relative z-10 grid gap-5 lg:grid-cols-[1.05fr_0.95fr] lg:items-start xl:gap-8">
            <div className="min-w-0">
              ...
              <div className="mt-4 max-w-[860px] space-y-3 text-[12px] font-medium leading-6 text-[#e8ddc8]/90 sm:text-[13px] sm:leading-7 lg:text-[14px]">
                <p>
                  «ОРМЕД-Кинезо» — установка для активно-пассивной
                  механотерапии позвоночника. Аппарат используется для
                  выполнения лечебных движений, направленных на восстановление
                  функций опорно-двигательной системы и улучшение обменных
                  процессов в тканях позвоночника.
                </p>
                ...
                <p>
                  ...
                  отделах позвоночника. Движения сочетаются с мягким
                  растяжением позвоночника и суставов.
                </p>
              </div>
            </div>
