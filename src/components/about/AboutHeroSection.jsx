...
export default function AboutHeroSection() {
  ...
  return (
    <section className="relative min-h-[100svh] overflow-hidden bg-[#020908]">
      <video
        ref={videoRef}
      ...
      <div className="relative z-10 flex min-h-[100svh] items-center px-5 pb-16 pt-20 sm:px-8 lg:px-12 xl:px-[5vw]">
        <div className="w-full max-w-[720px]">
          ...
          <h1 className="max-w-[700px] text-[clamp(3.2rem,5.8vw,6.8rem)] font-serif font-normal leading-[0.98] tracking-[-0.06em] text-[#f8f0dd] drop-shadow-[0_12px_34px_rgba(0,0,0,0.82)]">
            Магомед
            <br />
            Базаев
          </h1>
          ...
          <p className="mt-8 max-w-[620px] text-[17px] font-medium leading-8 text-[#f3e8cf] drop-shadow-[0_5px_18px_rgba(0,0,0,0.82)]">
            Лечение пациентов методами апитерапии и восстановительные курсы на основе силы
            пчёл.
          </p>
