  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto h-[clamp(390px,31vw,652px)] w-full max-w-[2047px] overflow-hidden bg-black">
        ...
        <div
          aria-hidden="true"
          className="pointer-events-none absolute inset-x-0 top-0 z-20 h-[10px] bg-[linear-gradient(180deg,rgba(0,0,0,1)_0%,rgba(0,0,0,0.92)_25%,rgba(0,0,0,0.58)_62%,rgba(0,0,0,0)_100%)]"
        />
